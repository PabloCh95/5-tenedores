...
export default function Favorites(props) {
  ...
  const [restaurants, setRestaurants] = useState(null); //aca vamos a almacenar a los restaurantes
  const [userLogged, setUserLogged] = useState(false);// vamos a comprobar los usuarios logueados
  ...
  useFocusEffect(
    ...
    //esto sirve para realizar una espera , para obtener todos los datos de los restaurantes.
...
//este componente es para renderizar cuando no hay restaurantes favoritos
...
//este componente es para mostrar cuando los usuarios no esten logueados
...
//componente para renderizar los restaurantes
